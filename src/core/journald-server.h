...
int config_parse_storage(const char *filename, unsigned line, const char *lvalue, int ltype, const char *rvalue, void *data);

const char *storage_to_string(Storage s) _const_;
Storage storage_from_string(const char *s) _pure_;

int config_parse_split_mode(const char *filename, unsigned line, const char *lvalue, int ltype, const char *rvalue, void *data);
